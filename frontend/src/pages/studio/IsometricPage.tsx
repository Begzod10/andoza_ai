              ...
              {WALL_COLORS.map((color) => (
                <button
                  ...
                  style={{
                    ...
                    // Brand blue selection ring — was '#D85A30' (the
                    // Terracotta *palette entry* two lines up, reused by
                    // mistake as if it were the brand accent).
              ...
              {OBOY_PATTERNS.map((p) => (
                ...
                >
                  <svg
                    ...
                    style={{
                      border: selectedPattern === p.id ? '2px solid #1E40AF' : '2px solid #E5E7EB',
                    }}
                  >
