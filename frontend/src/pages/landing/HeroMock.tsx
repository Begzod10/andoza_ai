    ...
    >
      ...
      <div className="absolute inset-4 rounded-2xl bg-white text-neutral-900 rotate-[-3deg] shadow-xl overflow-hidden">
        ...
        <div className="p-4 border-b border-neutral-100 flex items-center justify-between">
          <span className="text-sm font-bold text-primary">Mehmonxona</span>
      ...
      <div className="landing-float absolute -bottom-6 -left-6 rotate-[4deg] rounded-2xl bg-white text-neutral-900 shadow-xl p-4 w-48">
        <p className="text-[11px] text-neutral-500 font-semibold">Taxminiy smeta</p>
        <p className="text-xl font-extrabold text-primary">12 480 000 so'm</p>
        <p className="text-[11px] text-success font-semibold mt-1">
          Faqat kerakli materiallar
        </p>
      </div>
